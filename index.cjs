'use strict';
// Bank of the Lao PDR exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bol';
...
/** Latest rate for one pair, e.g. getRate('USD', 'LAK', { apiKey }). */
